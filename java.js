...
const nuevoBtn = document.getElementById('mibtn')
const videos = document.getElementById('videos')
let estado = 1

console.log(nuevoBtn.parentElement.firstElementChild.firstElementChild.firstElementChild.firstElementChild.id)

function playVideo(videoId) {
    console.log(nuevoBtn.parentElement.firstElementChild.firstElementChild.classList.contains('active'))
